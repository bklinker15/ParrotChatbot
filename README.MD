...
This is a simple echo bot for Microsoft Teams that echoes messages back to all of the user's devices.  Useful as a shared clipboard among devices or somewhere to jot down quick notes. 
